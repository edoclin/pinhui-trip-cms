    ...
    <el-table @sort-change='sortTable' border table-layout="auto" stripe :data="tableData.data" style="width: 100%"
      ...
      <el-table-column fixed="right" label="操作">
        ...
        <template #default="scope">
          <el-button type="success" @click="onEdit(scope.row)" size="small">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listBase, deleteBaseByIds, getBaseConditons, getTableCoumns } from '../../../api/base';
...
const queryConditions = ({ conditions, createdBetween, updatedBetween }) => {
...
const onEdit = (record) => {
  emit('onEdit', { record, component: BaseFormVue, title: '基地编辑', name: record.baseName })
}
</script>