...
import {
  ...
  getTrainCourseConditions,
  getTableColumns
} from 'src/api/train-course'
import AdvanceQuery from 'src/components/AdvanceQuery.vue'
import TrainCourseFormVue from './TrainCourseForm.vue'
...
getTrainCourseConditions().then(res => {
...
watch(page, () => {
  listTrainCourse(page.current, page.size, queryParam).then(res => {
