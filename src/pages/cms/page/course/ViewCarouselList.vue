<template>
  <el-tabs v-model="currentTab" stretch type="card" tab-position="left" @tab-change="handleTabChange">
    <el-tab-pane label="基地课程" name="BASE_COURSE">
      <draggable-transform v-if="showTransform && currentTab === 'BASE_COURSE'" :data="courseCarousel"
                           :right="currentModel" @onDraggableChange="handleChange"></draggable-transform>
    </el-tab-pane>
    <el-tab-pane label="培训课程" name="TRAIN_COURSE">
      <draggable-transform v-if="showTransform && currentTab === 'TRAIN_COURSE'" :data="courseCarousel"
                           :right="currentModel" @onDraggableChange="handleChange"></draggable-transform>
    </el-tab-pane>
  </el-tabs>
</template>
